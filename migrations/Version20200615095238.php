 ...
 */
final class Version20200615095238 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE freeitems (id INT AUTO_INCREMENT NOT NULL, category_id INT DEFAULT NULL, title VARCHAR(255) NOT NULL, description LONGTEXT NOT NULL, location VARCHAR(255) NOT NULL, date DATE NOT NULL, time TIME NOT NULL, picture01 VARCHAR(255) DEFAULT NULL, picture02 VARCHAR(255) DEFAULT NULL, picture03 VARCHAR(255) DEFAULT NULL, picture04 VARCHAR(255) DEFAULT NULL, picture05 VARCHAR(255) DEFAULT NULL, picture06 VARCHAR(255) DEFAULT NULL, INDEX IDX_818E999612469DE2 (category_id), INDEX title_idx (title), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
